...
<iframe src="https://www.youtube-nocookie.com/embed/4sPnOqeUDmk?playlist=4sPnOqeUDmk&amp;rel=0&amp;start=undefined&amp;end=undefined&amp;autoplay=undefined&amp;loop=undefined&amp;mute=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>

### [](https://docs.streamlit.io/develop/tutorials/chat-and-llm-apps/build-conversational-apps#stchat_message)st.chat\_message
...
### [](https://docs.streamlit.io/develop/tutorials/chat-and-llm-apps/build-conversational-apps#stchat_input)st.chat\_input
...
[_arrow\_back_Previous: Chat and LLM apps](https://docs.streamlit.io/develop/tutorials/chat-and-llm-apps)[_arrow\_forward_Next: Build an LLM app using LangChain](https://docs.streamlit.io/develop/tutorials/chat-and-llm-apps/llm-quickstart)
