...
TASK_LIBRARY = [
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Open or activate your account — this usually takes about 10 minutes online.", "time": "~10 min",
                 "sub_steps": [
            ...
            "medium": [
                ...
                {"text": "Complete the online enrollment form — you'll need your SSN and a photo ID.", "time": "~10 min", "sub_steps": [
                ...
                {"text": "Set your payroll contribution amount — even a small amount counts.", "time": "~5 min", "sub_steps": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Look for these words in the plan name or description: 'HDHP', 'High-Deductible', 'HSA-eligible', 'Consumer Choice', 'Bronze', or 'Catastrophic'.", "time": "~2 min", "sub_steps": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Set up automatic investing so you don't have to think about it again.", "time": "~3 min", "sub_steps": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Find out if your therapist accepts direct HSA card payment, or if you pay out of pocket and reimburse yourself.", "time": "~5 min", "sub_steps": [
                ...
                {"text": "Pay with your HSA debit card directly — done. Or if you paid out of pocket, request a receipt and reimburse yourself.", "time": "~5 min", "sub_steps": [
                ...
                {"text": "Save your receipt — a simple photo on your phone is enough.", "time": "~1 min"},
            ],
            "medium": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Check that the bill is accurate before you pay anything.", "time": "~10 min", "sub_steps": [
                ...
                {"text": "Check your HSA balance — log into your HSA provider's app or website.", "time": "~3 min"},
                {"text": "If your HSA covers it: pay with your HSA debit card, or pay another way and reimburse yourself.", "time": "~5 min"},
                {"text": "Save the receipt and any payment confirmation.", "time": "~2 min"},
            ],
            "medium": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Ask your provider if they accept HSA/FSA cards — almost all dental and vision offices do.", "time": "~2 min"},
                {"text": "Pay with your HSA debit card at the appointment, or reimburse yourself afterward.", "time": "~5 min"},
                {"text": "Keep your receipt.", "time": "~1 min"},
            ],
            "medium": [
                {"text": "Confirm the expense qualifies: dental cleanings, fillings, braces, implants, eye exams, glasses, contacts, LASIK all qualify. Cosmetic-only (teeth whitening) don't.", "time": "~1 min"},
            ...
            "detailed": [
                {"text": "Confirm the specific expense is qualified. HSA-eligible: cleanings, fillings, extractions, crowns, root canals, braces, dentures, implants, eye exams, prescription glasses, contact lenses, solution, LASIK.", "time": "~2 min"},
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Photograph or screenshot every receipt right after paying — it takes 10 seconds.", "time": "~1 min"},
                {"text": "That's it. No spreadsheet required.", "time": "~0 min"},
            ],
            "medium": [
    ...
    },
    {
        ...
        "steps": {
            "gentle": [
                ...
                {"text": "Do a rough 'real cost' comparison.", "time": "~5 min", "sub_steps": [
...
def flatten_steps(steps_list: list) -> list[str]:
    ...
    for step in steps_list:
        if isinstance(step, dict):
            ...
            line = f"{text} ({time_est})" if time_est else text
            if text:
                flat.append(line)
